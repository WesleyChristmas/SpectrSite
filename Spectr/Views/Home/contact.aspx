...
<div class="container">
	<div class="single-post-container clearfix">
		...
		<!-- start article -->
		<article id="12" class="post-wrap post page">
			<header class="post-header">
				<h2 class="post-title"><a href="/contact/">Контакты</a></h2>
			</header>
			<div class="post-content">
				<p><featured><iframe width="600" height="450" frameborder="0" style="border:0"  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAPWBr2adCFPFoEv-9czJxJVznrovHM3I4
    &q=б-р+Генерала+Карбышева,+9к1,+Москва,+123154" allowfullscreen>
                            </iframe></featured></p>

<h3 id="address">Адрес</h3>

<p>г Москва<br />
б-р Генерала Карбышева, д.9, к.1, кв.7<br />
Тел. 8(499)1990055  <br />
Email: <a href="mailto:gbjsolution@gmail.com">avia@nppf-spectr.ru</a></p>
			</div>
		</article>
		<!-- end article -->
		</div>
...
<!--    <script src="/public/jquery.min.js?v=1c3364e6d2"></script>-->
	<script src="Scripts/jquery-1.11.3.min.js?v=1c3364e6d2"></script>
	<script src="Scripts/bootstrap.min.js?v=1c3364e6d2"></script>
	<script src="Scripts/imagesloaded.pkgd.min.js?v=1c3364e6d2"></script>
	<script src="Scripts/masonry.pkgd.min.js?v=1c3364e6d2"></script>
	<script src="Scripts/jquery.fitvids.js?v=1c3364e6d2"></script>
	<script src="Scripts/highlight.pack.js?v=1c3364e6d2"></script>
	<script src="Scripts/jquery.ghostHunter.min.js?v=1c3364e6d2"></script>
	<script src="Scripts/main.js?v=1c3364e6d2"></script>
</body>
</html>