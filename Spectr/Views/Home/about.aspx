...
<head>
	...
	<title>About Spectr</title>
	<meta name="description" content="" />
	<meta name="keywords" content="">
	<meta name="viewport" content="width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no" />
	<!-- fav icons -->
	<link rel="shortcut icon" href="assets/images/favicon.ico?v=1c3364e6d2">
	<link rel="apple-touch-icon" href="assets/images/apple-touch-icon.png?v=1c3364e6d2">
	<link rel="apple-touch-icon" sizes="72x72" href="assets/images/apple-touch-icon-72x72.png?v=1c3364e6d2">
	<link rel="apple-touch-icon" sizes="114x114" href="assets/images/apple-touch-icon-114x114.png?v=1c3364e6d2">
	<!-- stylesheets -->
	<title>Document</title>
	<link href='http://fonts.googleapis.com/css?family=Roboto:400,300,700' rel='stylesheet' type='text/css'>
	<link rel="stylesheet" href="assets/css/bootstrap.min.css?v=1c3364e6d2">
	<link rel="stylesheet" href="assets/css/font-awesome.min.css?v=1c3364e6d2">
	<link rel="stylesheet" type="text/css" href="assets/css/hl-styles/monokai_sublime.css?v=1c3364e6d2">
	<link rel="stylesheet" type="text/css" href="assets/css/screen.css?v=1c3364e6d2">
	<!-- only for demo -->
	<link rel="stylesheet" type="text/css" href="assets/assets/css/colpick.css?v=1c3364e6d2">
	
</head>
<body class="post-template page-template page">
	<div class="page-wrap" style="background-image: url(content/images/bg-1.jpg)" >
	<div class="overlay">
		<!-- start header -->
...
<div id="navbar" class="navbar-collapse collapse">
	<ul class="nav navbar-nav">
		...
		<li data-item="about" class="about "><a href="about.html">О нас</a></li>
...
<div class="container">
	<div class="single-post-container clearfix">
		...
		<!-- start article -->
		<article id="2" class="post-wrap post page">
			<header class="post-header">
				<h2 class="post-title"><a href="/about/">О нас</a></h2>
			</header>
			<div class="post-content">
				<p><strong>Vasha</strong> is a very neat and clean and minimal masonry style theme for <a href="http://ghost.org/">Ghost</a> blogging platform. it is designed focusing content in mind. So that visitor and reader can concentrate in your article. There is no clutter and over bloating unnecessary element throughout the design.</p>

<p>Now if you are thinking that a content focus theme means we don't care about your image video or audio then please read on.</p>

<p>This theme is not only for text content. It will handle rich media like image, video and audio in a nice way. In latest version of Ghost now you can add a cover image in each post. Vasha is smart enough to handle that. </p>

<p>Also in this theme there is a very simple but powerful inbuilt feature which allow you to use any embedded media like <strong>YouTube video, Vimeo video, Sound cloud audio, Mix cloud audio or any other embedded iframe as your featured / or cover media to your post or static page.</strong> Oh! also embedded <strong>google map</strong> can be used at the place of featured media. Working example of google map is on the <a href="http://vasha-ghost.gbjsolution.com/contact/">contact</a> page.</p>

<p>So If you are going to start a fresh blog and looking for a nice ghost theme for your personal blog, multi-author blog or journal, Vasha will perfectly fit in your need.</p>

<p>We will keep updating this theme time to time. If you find any bug or want a feature in a future version please let me know. Will try best to solve / add those in future version.</p>
			</div>
		</article>
		<!-- end article -->
		</div>
...
<div class="widget">
	...
	<div class="content newsletter">
		<p>Вы можете оставить сообщение для нас</p>
		<div id="mc_embed_signup">
			<form action="#" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate>
				<div class="input-group">
                    <input type="email" value="" name="MESSAGE" class="required email" id="mce-EMAIL" placeholder="Сообщение">
					<input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="e-mail">
				</div>
				<div class="input-group">
					<input type="submit" value="Отправить" name="send" id="mc-embedded-subscribe" class="btn btn-default">
				</div>
			</form>
		</div>
		<div id="message"></div>
...
<!-- end main content area -->
    ...
    <script src="/public/jquery.min.js?v=1c3364e6d2"></script>
	<script src="assets/js/jquery-1.11.3.min.js?v=1c3364e6d2"></script>
	<script src="assets/js/bootstrap.min.js?v=1c3364e6d2"></script>
	<script src="assets/js/imagesloaded.pkgd.min.js?v=1c3364e6d2"></script>
	<script src="assets/js/masonry.pkgd.min.js?v=1c3364e6d2"></script>
	<script src="assets/js/jquery.fitvids.js?v=1c3364e6d2"></script>
	<script src="assets/js/highlight.pack.js?v=1c3364e6d2"></script>
	<script src="assets/js/jquery.ghostHunter.min.js?v=1c3364e6d2"></script>
	<script src="assets/js/main.js?v=1c3364e6d2"></script>
</body>
</html>