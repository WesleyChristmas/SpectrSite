	...
	<div class="single-post-container clearfix">
		...
		<article id="2" class="post-wrap post page">
			<header class="post-header">
				<h2 class="post-title"><a href="/about/">Flight Plan</a></h2>
			</header>
			<div class="post-content">
				<p>Здесь вы можете ввести параметры Вашего летного пути или загрузить уже имеющийся план полета в формате .pnh</p>
                 <div class="input-group">
					<input type="submit" value="Загрузить план полета" name="send" id="mc-embedded-subscribe" class="btn btn-default">
				</div>
                <textarea id="route" name="route" placeholder=""></textarea>
			</div>
		</article>
		<!-- end article -->
		</div>
...
<div class="widget">
	...
	<div class="content newsletter">
		...
		<div id="mc_embed_signup">
				<div class="input-group">
                    <input type="param" value="" name="" class="required email" id="" placeholder="Время вылета">
					<input type="param" value="" name="" class="required email" id="" placeholder="Время посадки">
                    <input type="param" value="" name="" class="required email" id="" placeholder="Маска угла">
                    <select type="param" id="optype">
                        <option value="31">NPA</option>
                        <option value="2">Терминал</option>
                    </select>
                    <select type="param" id="optype">
                        <option value="31">GNSS</option>
                        <option value="2">GPS</option>
                        <option value="2">GLONASS</option>
                    </select>
				</div>
				<div class="input-group">
					<input type="submit" value="Получить прогноз" name="send" id="mc-embedded-subscribe" class="btn btn-default">
				</div>
		</div>
	</div>
</div>
<!-- end tag cloud widget -->	
        ...
        <div id="map" style=" width: 100%; height: 500px; margin: 50px 0;"></div>
</div>
